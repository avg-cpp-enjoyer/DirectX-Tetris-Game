...
void UI::Init() {
	...
	General::tetraminoCornerRad            = 3.0f * scaleFactor;
	...
	MainWindow::Preview::prHeight          = 168.0f * scaleFactor;
	MainWindow::Preview::padding           = 10.0f  * scaleFactor;
	MainWindow::Preview::topPadding        = 50.0f  * scaleFactor;
	...
	MainWindow::d2dWindowRect = D2D1::RoundedRect(D2D1::RectF(0.0f, 0.0f, 
			...
			static_cast<float>(MainWindow::mwHeight) - 2.0f * scaleFactor), 
		MainWindow::cornerRadius, MainWindow::cornerRadius
	);
	...
	GameOver::goWidth            = 350.0f * scaleFactor;
	GameOver::goHeight           = 250.0f * scaleFactor;
	GameOver::btnWidth           = 100.0f * scaleFactor;
	GameOver::btnHeight          = 40.0f  * scaleFactor;
	GameOver::btnSpacing         = 20.0f  * scaleFactor;
	GameOver::btnRadius          = 10.0f  * scaleFactor;
	...
	GameOver::btnPosY            = 150.0f * General::scaleFactor;
	...
	GameOver::gameOverRect = { 0.0f, 0.0f,
		GameOver::goWidth - 2.0f * scaleFactor,
		GameOver::goHeight - 2.0f * scaleFactor,
		UI::MainWindow::cornerRadius,
		UI::MainWindow::cornerRadius
	};

	GameOver::textRect = D2D1::RectF(0.0f, 0.0f, GameOver::goWidth, GameOver::goHeight - 80.0f);
}